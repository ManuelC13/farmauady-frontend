    ...
    <div className="bg-background overflow-hidden rounded-xl">
      ...
      <div className="overflow-auto max-h-[500px]">
        <table className="w-full text-left">
          {/* Header */}
          <thead>
            <tr className="border-b border-gray-300 bg-background sticky top-0 z-10">
                ...
                <tr key={user.id_user} className="border-b border-gray-300 hover:bg-secondary/10 transition">
                  ...
                  <td className="py-4 px-4">
                    {user.role?.name === "Administrador" ? (
                      ...
                      <span className="inline-flex items-center px-3 py-1 rounded-full bg-gray-200 text-gray-500 text-sm font-medium">
                        Vendedor
                      </span>
                    )}
                  </td>
